...
-- Migración de Limpieza Completa y Reconstrucción
-- Fecha: 2025-09-23
-- ===========================================

-- ===========================================
-- 1. LIMPIAR TODO (DROP IF EXISTS)
-- ===========================================

-- Eliminar políticas primero
DROP POLICY IF EXISTS "Allow all operations on session_evaluations" ON session_evaluations;
DROP POLICY IF EXISTS "Allow all operations on session_notes" ON session_attendance;
...
CREATE FUNCTION reorder_meeting_stages(
    p_meeting_id UUID,
...
CREATE FUNCTION get_meeting_stages_ordered(p_meeting_id UUID)        
RETURNS TABLE (
    id UUID,
    meeting_id UUID,
    stage_name VARCHAR(100),
...
CREATE FUNCTION create_default_stages(
    p_meeting_id UUID,
...
-- ===========================================
-- FIN DE LA MIGRACIÓN DE LIMPIEZA COMPLETA
-- ===========================================
